...
export const agent: AgentConfig = {
	...
	animations: {
		...
		Congratulate: {
			frames: [
				{ duration: 100, images: [[1488, 0]], sound: "13" },
				...
				{ duration: 100, images: [[2480, 0]], sound: "17" },
		...
		SendMail: {
			frames: [
				{ duration: 100, images: [[0, 0]], sound: "13" },
				{ duration: 100, images: [[0, 279]] },
				{ duration: 100, images: [[124, 279]] },
				{ duration: 100, images: [[248, 279]], sound: "11" },
				...
				{ duration: 100, images: [[1984, 279]], sound: "2" },
				...
				{ duration: 100, images: [[248, 372]], sound: "7" },
		...
		Save: {
			frames: [
				...
				{ duration: 100, images: [[1488, 372]], sound: "19" },
				...
				{ duration: 100, images: [[2480, 372]], sound: "20" },
				...
				{ duration: 100, images: [[2232, 465]], sound: "21" },
		...
		GetAttention: {
			frames: [
				...
				{ duration: 100, images: [[2108, 744]], sound: "10" },
				{ duration: 100, images: [[2232, 744]] },
				{ duration: 100, images: [[2356, 744]], sound: "10" },
				...
				{ duration: 100, images: [[868, 837]], sound: "4" },
		...
		Processing: {
			frames: [
				...
				{ duration: 100, images: [[868, 1209]], sound: "11" },
				...
				{ duration: 100, images: [[0, 1302]], sound: "5" },
				...
				{ duration: 100, images: [[620, 1302]], sound: "14" },
				...
				{ duration: 100, images: [[1984, 1302]], sound: "11" },
		...
		DeepIdleE: {
			frames: [
				...
				{ duration: 100, images: [[2480, 930]] },
				{ duration: 100, images: [[2604, 930]] },
				{ duration: 100, images: [[2728, 930]], sound: "9" },
				{ duration: 150, images: [[2852, 930]] },
				{ duration: 150, images: [[0, 1023]] },
				{ duration: 350, images: [[124, 1023]] },
				{
		...
		GoodBye: {
			frames: [
				...
				{ duration: 100, images: [[0, 2790]], sound: "15" },
		...
		Hearing_1: {
			frames: [
				...
				{ duration: 100, images: [[620, 837]] },
				{ duration: 100, images: [[744, 837]] },
				{ duration: 100, images: [[868, 837]], sound: "1" },
				{ duration: 100, images: [[992, 837]] },
				{ duration: 100, images: [[1116, 837]] },
				{ duration: 100, images: [[1240, 837]] },
				{ duration: 100, images: [[1364, 837]] },
		...
		Wave: {
			frames: [
				...
				{ duration: 100, images: [[1984, 1581]], sound: "2" },
				{ duration: 100, images: [[2108, 1581]] },
				{ duration: 100, images: [[2232, 1581]], sound: "2" },
				{ duration: 450, images: [[2356, 1581]], sound: "9" },
				{ duration: 100, images: [[2480, 1581]] },
				{ duration: 1200, images: [[2356, 1581]] },
				{ duration: 100, images: [[2604, 1581]] },
				{ duration: 100, images: [[2728, 1581]] },
				{ duration: 100, images: [[2852, 1581]], sound: "3" },
		...
		Writing: {
			frames: [
				{ duration: 100, images: [[248, 1674]], sound: "13" },
				...
				{ duration: 100, images: [[620, 1860]], sound: "11" },
		...
		GetArtsy: {
			frames: [
				...
				{ duration: 100, images: [[1240, 1581]] },
				{ duration: 100, images: [[1364, 1581]] },
				{ duration: 100, images: [[1488, 1581]], sound: "1" },
				{ duration: 100, images: [[1612, 1581]] },
				{ duration: 100, images: [[1736, 1581]] },
				{ duration: 100, images: [[1860, 1581]] },
				{ duration: 100, images: [[1984, 1581]], sound: "2" },
				{ duration: 100, images: [[2108, 1581]] },
				{ duration: 100, images: [[1860, 1953]], sound: "2" },
				...
				{ duration: 100, images: [[2604, 1953]], sound: "2" },
				{ duration: 100, images: [[2728, 1953]] },
				{ duration: 100, images: [[2852, 1953]], sound: "2" },
				{ duration: 100, images: [[0, 2046]] },
				{ duration: 100, images: [[124, 2046]], sound: "2" },
				{ duration: 100, images: [[248, 2046]] },
				{ duration: 100, images: [[372, 2046]], sound: "2" },
				...
				{ duration: 100, images: [[1116, 2046]], sound: "9" },
		...
		Searching: {
			frames: [
				...
				{ duration: 100, images: [[992, 2139]], sound: "11" },
				...
				{ duration: 100, images: [[1736, 2139]] },
				{ duration: 100, images: [[1612, 2139]], sound: "11" },
				{ duration: 100, images: [[1116, 2139]] },
				{
					duration: 100,
					images: [[1240, 2139]],
		...
		DeepIdleA: {
			frames: [
				...
				{ duration: 100, images: [[1736, 930]] },
				{ duration: 100, images: [[1860, 930]] },
				{ duration: 100, images: [[1984, 930]], sound: "9" },
				{ duration: 100, images: [[2108, 930]] },
				{ duration: 100, images: [[2232, 930]] },
				{ duration: 100, images: [[2356, 930]] },
				{ duration: 100, images: [[2480, 930]] },
		...
		EmptyTrash: {
			frames: [
				...
				{ duration: 100, images: [[868, 2418]], sound: "2" },
		...
		Greeting: {
			frames: [
				...
				{ duration: 100, images: [[372, 2511]], sound: "1" },
				...
				{ duration: 100, images: [[1984, 2511]], sound: "12" },
				...
				{ duration: 100, images: [[992, 837]], sound: "4" },
				{ duration: 100, images: [[1116, 837]] },
				{ duration: 100, images: [[1240, 837]] },
				{ duration: 100, images: [[1364, 837]] },
				{ duration: 100, images: [[1488, 837]] },
				...
				{ duration: 100, images: [[2852, 2511]], sound: "15" },
